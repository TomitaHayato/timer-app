...
// 指定された日の記録を取得
export const getRecordsByDate = async(prisma: PrismaClient, userId: string, beforeDaysFromToday: number = 0) => {
...
// 指定された週の記録を取得
export const getRecordsByWeek = async(prisma: PrismaClient, userId: string, beforeWeeksFromToday: number = 0) => {
...
// 指定された月の記録を取得
export const getRecordsByMonth = async(prisma: PrismaClient, userId: string, beforeMonthsFromToday: number = 0) => {
